...
public:
  ...
  // set minimum limit for positionWithLimit
  void setMin(long minValue) { _limitMin = minValue; }

  // set maximum limit for positionWithLimit
  void setMax(long maxValue) { _limitMax = maxValue; }
...
private:
  ...
  unsigned long _limitMin = LONG_MIN; // Minimum limit for positionWithLimit
  unsigned long _limitMax = LONG_MAX; // Maximum limit for positionWithLimit
};
